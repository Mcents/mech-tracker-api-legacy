...
RSpec.describe BuildPosts, type: :model do
  context 'posts' do
    it 'builds and searches posts' do
      user = create(:user, username: 'mikec', email: 'mike@test.com', password: 'test')
      ...
      post = create(:post, wanting_terms: "paypal", buying_terms: "GMK Taro", url: "www.reddit.com", location: "NJ")
